          ...
          <div v-if="brasserie.id === currentBrasserieId" class="mt-3">
            ...
            <ul class="list-group">
              <li v-for="biere in bieres" :key="biere.id" class="list-group-item">
                {{ biere.nom }} - {{ biere.type }} - {{ biere.degreAlcool }}%
            ...
            <div class="form-inline mt-3">
              ...
              <input v-model="newBiere.degreAlcool" class="form-control mb-2 mr-sm-2" placeholder="Degré d'Alcool">
  ...
  export default {
    ...
    methods: {
      ...
      async addBiere(brasserieId) {
        ...
        await addDoc(biereCollection, this.newBiere);
        this.newBiere = { nom: "", type: "", degreAlcool: "" };
      },
